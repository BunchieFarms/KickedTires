...
export class FeaturedListComponent implements OnInit {
  ...
  featuredListItems = [
    ...
    { 'image': this.images[1], 'seller': 'Private Owner', 'location': 'Darby, TX', 'description': '2012 Dodge Charger SXT', 'price': 4900 },
    { 'image': this.images[2], 'seller': 'Private Owner', 'location': 'Leland, NC', 'description': '1972 Ford Ranger', 'price': 3500 },
    { 'image': this.images[3], 'seller': 'Dealer', 'location': 'San Diego, CA', 'description': '2019 Chevrolet Camaro SS', 'price': 31000 },
    { 'image': this.images[4], 'seller': 'Private Owner', 'location': 'Santa Barbara, CA', 'description': '1972 VW Bug', 'price': 5000 },
